...
function toPromise(observable) {
  ...
  return new Promise(function(resolve, reject) {
    observable.subscribe({
      next: function(data) {
        if (completed) {
          globalThis.__DEV__ !== false && invariant2.warn(57);
        } else {
          completed = true;
          resolve(data);
        }
...
function getAccessorWarningDescriptor(fieldName, value, path, operationName2, operationType) {
  var getValue = function() {
    ...
    globalThis.__DEV__ !== false && invariant2.warn(60, operationName2 ? "".concat(operationType, " '").concat(operationName2, "'") : "anonymous ".concat(operationType), "".concat(path, ".").concat(fieldName).replace(/^\./, ""));
    getValue = function() {
      return value;
    };
    return value;
  ...
  function() {
      ...
      return this.batch({
        update: function(cache2) {
          var value = muteDeprecations("canonizeResults", function() {
            return cache2.readQuery(options);
          });
    ...
    ApolloCache2.prototype.updateFragment = function(options, update) {
      ...
      return this.batch({
        update: function(cache2) {
          var value = muteDeprecations("canonizeResults", function() {
            return cache2.readFragment(options);
          });
          var data = update(value);
          if (data === void 0 || data === null)
            return value;
...
function getApolloContext() {
  invariant2("createContext" in React, 69);
...
var resetApolloContext = function() {
  if (globalThis.__DEV__ !== false) {
    globalThis.__DEV__ !== false && invariant2.warn(70);
  }
...
var ApolloConsumer = function(props) {
  ...
  return React2.createElement(ApolloContext.Consumer, null, function(context) {
    invariant2(context && context.client, 68);
...
var useSyncExternalStore = realHook || function(subscribe2, getSnapshot, getServerSnapshot) {
  ...
  if (
    ...
    globalThis.__DEV__ !== false && invariant2.error(92);
  }
...
function parser(document) {
  warnDeprecated("parser", function() {
    globalThis.__DEV__ !== false && invariant2.warn(94);
  });
  if (!cache) {
  ...
  invariant2(!!document && !!document.kind, 95, document);
  var fragments = [];
  var queries = [];
  var mutations = [];
  var subscriptions = [];
  ...
  invariant2(!fragments.length || queries.length || mutations.length || subscriptions.length, 96);
  invariant2(
  ...
  invariant2(definitions.length === 1, 98, document, definitions.length);
...
// node_modules/@apollo/client/react/hooks/internal/useWarnRemoved.js
...
function useWarnRemovedOption(options, name, callSite, recommendation) {
  ...
  var didWarn = React10.useRef(false);
  if (name in options && !didWarn.current) {
    globalThis.__DEV__ !== false && invariant2.warn(78, callSite, name, recommendation);
...
function useInternalState(client, query, options, renderPromises, makeWatchQueryOptions) {
  ...
  var _a2 = React12.useState(createInternalState), internalState = _a2[0], updateInternalState = _a2[1];
...
function useQueryInternals(query, options) {
  ...
  var renderPromises = React12.useContext(getApolloContext()).renderPromises;
  ...
  var obsQueryFields = React12.useMemo(function() {
...
function useObservableSubscriptionResult(resultData, observable, client, options, watchQueryOptions, disableNetworkFetches, partialRefetch, isSyncSSR, callbacks) {
  var callbackRef = React12.useRef(callbacks);
  ...
  var currentResultOverride = React12.useMemo(function() {
    return resultOverride && toQueryResult(resultOverride, previousData, observable, client);
  }, [client, observable, resultOverride, previousData]);
  return useSyncExternalStore(React12.useCallback(function(handleStoreChange) {
...
function bindObservableMethods(observable) {
  return {
    ...
    reobserve: function() {
      ...
      if (globalThis.__DEV__ !== false) {
        globalThis.__DEV__ !== false && invariant2.warn(84);
      }
...
function useLazyQuery(query, options) {
  ...
  var execOptionsRef = React13.useRef(void 0);
  var optionsRef = React13.useRef(void 0);
  var queryRef = React13.useRef(void 0);
  ...
  var forceUpdateState = React13.useReducer(function(tick) {
    return tick + 1;
  }, 0)[1];
  var eagerMethods = React13.useMemo(function() {
    var eagerMethods2 = {};
    var _loop_1 = function(key2) {
      ...
      eagerMethods2[key2] = function() {
        if (globalThis.__DEV__ !== false) {
          if (key2 === "reobserve") {
            globalThis.__DEV__ !== false && invariant2.warn(80);
          }
        }
  ...
  var execute3 = React13.useCallback(function(executeOptions) {
    if (globalThis.__DEV__ !== false) {
      ...
      for (var _a3 = 0, DEPRECATED_EXECUTE_OPTIONS_1 = DEPRECATED_EXECUTE_OPTIONS; _a3 < DEPRECATED_EXECUTE_OPTIONS_1.length; _a3++) {
        var name_2 = DEPRECATED_EXECUTE_OPTIONS_1[_a3];
  ...
  var executeRef = React13.useRef(execute3);
  useIsomorphicLayoutEffect(function() {
    executeRef.current = execute3;
  });
  var stableExecute = React13.useCallback(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
function useMutation(mutation, options) {
  ...
  var execute3 = React14.useCallback(function(executeOptions) {
  ...
  var reset = React14.useCallback(function() {
...
function useSubscription(subscription, options) {
  ...
  var hasIssuedDeprecationWarningRef = React15.useRef(false);
  var client = useApolloClient(options.client);
  verifyDocumentType(subscription, DocumentType.Subscription);
  if (!hasIssuedDeprecationWarningRef.current) {
    hasIssuedDeprecationWarningRef.current = true;
    if (options.onSubscriptionData) {
      globalThis.__DEV__ !== false && invariant2.warn(options.onData ? 85 : 86);
    }
    if (options.onSubscriptionComplete) {
      globalThis.__DEV__ !== false && invariant2.warn(options.onComplete ? 87 : 88);
    }
  }
  ...
  var _a2 = React15.useState(options.skip ? null : recreate), observable = _a2[0], setObservable = _a2[1];
  var recreateRef = React15.useRef(recreate);
  useIsomorphicLayoutEffect(function() {
  ...
  var optionsRef = React15.useRef(options);
  React15.useEffect(function() {
    optionsRef.current = options;
  });
  var fallbackLoading = !skip && !ignoreResults;
  var fallbackResult = React15.useMemo(function() {
    return {
  ...
  var ignoreResultsRef = React15.useRef(ignoreResults);
  useIsomorphicLayoutEffect(function() {
    ignoreResultsRef.current = ignoreResults;
  });
  var ret = useSyncExternalStore(React15.useCallback(function(update) {
    if (!observable) {
      return function() {
      };
    }
  ...
  var restart = React15.useCallback(function() {
    invariant2(!optionsRef.current.skip, 89);
...
function useReactiveVar(rv) {
  return useSyncExternalStore(React16.useCallback(function(update) {
...
function useFragment_(options) {
  ...
  var id = React17.useMemo(function() {
  ...
  var diff = React17.useMemo(function() {
    ...
    var diff2 = muteDeprecations("canonizeResults", function() {
      return cache3.diff(__assign(__assign({}, stableOptions), { returnPartialData: true, id: from3, query: cache3["getFragmentDoc"](fragment, fragmentName), optimistic }));
    });
    return {
  ...
  var getSnapshot = React17.useCallback(function() {
    return diff.result;
  }, [diff]);
  return useSyncExternalStore(React17.useCallback(function(forceUpdate) {
    var lastTimeout = 0;
...
function assertWrappedQueryRef(queryRef) {
  invariant2(!queryRef || QUERY_REFERENCE_SYMBOL in queryRef, 93);
}
...
var FragmentReference = (
  ...
  function() {
    ...
    FragmentReference2.prototype.handleNext = function(result2) {
      var _a2;
      switch (this.promise.status) {
        case "pending": {
          if (result2.complete) {
            return (_a2 = this.resolve) === null || _a2 === void 0 ? void 0 : _a2.call(this, result2.data);
          }
          this.deliver(this.promise);
          break;
        }
        case "fulfilled": {
          if (equal(this.promise.value, result2.data)) {
            return;
          }
          this.promise = result2.complete ? createFulfilledPromise(result2.data) : this.createPendingPromise();
          this.deliver(this.promise);
        }
      }
    };
...
function useSuspenseQuery_(query, options) {
  ...
  var _b = React18.useState([queryRef.key, queryRef.promise]), current = _b[0], setPromise = _b[1];
  ...
  var skipResult = React18.useMemo(function() {
...
function validateFetchPolicy(fetchPolicy) {
  ...
  invariant2(supportedFetchPolicies.includes(fetchPolicy), 90, fetchPolicy);
}
function validatePartialDataReturn(fetchPolicy, returnPartialData) {
  if (fetchPolicy === "no-cache" && returnPartialData) {
    globalThis.__DEV__ !== false && invariant2.warn(91);
  }
}
...
function useBackgroundQuery_(query, options) {
  ...
  var fetchPolicy = watchQueryOptions.fetchPolicy, variables = watchQueryOptions.variables;
  var _a2 = options.queryKey, queryKey = _a2 === void 0 ? [] : _a2;
  var didFetchResult = React19.useRef(fetchPolicy !== "standby");
  ...
  var _b = React19.useState(wrapQueryRef(queryRef)), wrappedQueryRef = _b[0], setWrappedQueryRef = _b[1];
  ...
  var refetch = React19.useCallback(function(variables2) {
    var promise2 = queryRef.refetch(variables2);
    setWrappedQueryRef(wrapQueryRef(queryRef));
    return promise2;
  }, [queryRef]);
...
function useSuspenseFragment_(options) {
  ...
  var cache2 = client.cache;
  var id = React20.useMemo(function() {
    return typeof from2 === "string" ? from2 : from2 === null ? null : cache2.identify(from2);
  }, [cache2, from2]);
  ...
  var _a2 = React20.useState(fragmentRef === null ? NULL_PLACEHOLDER : [fragmentRef.key, fragmentRef.promise]), current = _a2[0], setPromise = _a2[1];
...
function useLoadableQuery(query, options) {
  ...
  var watchQueryOptions = useWatchQueryOptions({ client, query, options });
  var _a2 = options.queryKey, queryKey = _a2 === void 0 ? [] : _a2;
  var _b = React21.useState(null), queryRef = _b[0], setQueryRef = _b[1];
  ...
  var calledDuringRender = useRenderGuard();
  var fetchMore = React21.useCallback(function(options2) {
    if (!internalQueryRef) {
  ...
  var refetch = React21.useCallback(function(options2) {
    if (!internalQueryRef) {
      throw new Error("The query has not been loaded. Please load the query.");
    }
  ...
  var loadQuery = React21.useCallback(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
    invariant2(!calledDuringRender(), 82);
    var variables = args[0];
    var cacheKey = __spreadArray([
      query,
      canonicalStringify(variables)
    ], [].concat(queryKey), true);
    var queryRef2 = muteDeprecations("canonizeResults", function() {
      return suspenseCache.getQueryRef(cacheKey, function() {
  ...
  var subscribeToMore = React21.useCallback(function(options2) {
    invariant2(internalQueryRef, 83);
    return internalQueryRef.observable.subscribeToMore(
      // TODO: The internalQueryRef doesn't have TVariables' type information so we have to cast it here
      options2
    );
  }, [internalQueryRef]);
  var reset = React21.useCallback(function() {
    setQueryRef(null);
  }, []);
...
function useQueryRefHandlers_(queryRef) {
  assertWrappedQueryRef(queryRef);
  var _a2 = React22.useState(queryRef), previousQueryRef = _a2[0], setPreviousQueryRef = _a2[1];
  var _b = React22.useState(queryRef), wrappedQueryRef = _b[0], setWrappedQueryRef = _b[1];
  var internalQueryRef = unwrapQueryRef(queryRef);
  ...
  var refetch = React22.useCallback(function(variables) {
    var promise = internalQueryRef.refetch(variables);
    setWrappedQueryRef(wrapQueryRef(internalQueryRef));
    return promise;
  }, [internalQueryRef]);
  var fetchMore = React22.useCallback(function(options) {
...
function useReadQuery_(queryRef) {
  assertWrappedQueryRef(queryRef);
  var internalQueryRef = React23.useMemo(function() {
    return unwrapQueryRef(queryRef);
  }, [queryRef]);
  var getPromise = React23.useCallback(function() {
  ...
  var promise = useSyncExternalStore(React23.useCallback(function(forceUpdate) {
...
var _createQueryPreloader = function(client) {
  function preloadQuery(query, options) {
    ...
    var queryRef = muteDeprecations("canonizeResults", function() {
      var _a2, _b;
      return new InternalQueryReference(client.watchQuery(__assign(__assign({}, options), { query })), {
